...
echo y | sfdx force:package:install -p 04tHo000000gxNl --target-org ${CIRCLE_BRANCH} -w 5 --security-type AllUsers
echo y | sfdx force:package:install -p 04t3o000001QbwP --target-org ${CIRCLE_BRANCH} -w 5 --security-type AllUsers
